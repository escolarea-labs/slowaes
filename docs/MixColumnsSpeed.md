...
```ruby
def mixColumns 
    t = "\000" * 16 4. times do |c | t[c * 4] = G2X.at(@state[c * 4]) ^  G3X.at(@state[1 + c * 4]) ^ @state[2 + c * 4] ^ @state[3 + c * 4]
    t[1 + c * 4] = @state[c * 4] ^ G2X.at(@state[1 + c * 4]) ^ G3X.at(@state[2 + c * 4]) ^ @state[3 + c * 4] 
    t[2 + c * 4] = @state[c * 4] ^ @state[1 + c * 4] ^ G2X.at(@state[2 + c * 4]) ^ G3X.at(@state[3 + c * 4]) 
    t[3 + c * 4] = G3X.at(@state[c * 4]) ^ @state[1 + c * 4] ^ @state[2 + c * 4] ^ G2X.at(@state[3 + c * 4])
    end@ state = t 
end 
